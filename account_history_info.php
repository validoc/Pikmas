    ...
    <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr bgcolor="#9F7EA9">
            <td class="main" colspan="2"><b style="color:#fff"><?php echo sprintf(HEADING_ORDER_NUMBER, $HTTP_GET_VARS['order_id']) . ' <small>(' . $order->info['orders_status'] . ')</small>'; ?></b></td>
          </tr>
          <tr>
...
?>
            <td width="30%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr  bgcolor="#9F7EA9">
                <td  class="main"><b style="color:#fff"><?php echo HEADING_DELIVERY_ADDRESS; ?></b></td>
              </tr>
              <tr>
...
?>
              <tr  bgcolor="#9F7EA9">
                <td class="main"><b style="color:#fff"><?php echo HEADING_SHIPPING_METHOD; ?></b></td>
              </tr>
              <tr>
...
?>
                  <tr  bgcolor="#9F7EA9">
                    <td class="main" colspan="2"><b style="color:#fff"><?php echo HEADING_PRODUCTS; ?></b></td>
                    <td class="smallText" align="right"><b style="color:#fff"><?php echo HEADING_TAX; ?></b></td>
                    <td class="smallText" align="right"><b style="color:#fff"><?php echo HEADING_TOTAL; ?></b></td>
                  </tr>
<?php
  } else {
?>
                  <tr  bgcolor="#9F7EA9">
                    <td class="main" colspan="3"><b style="color:#fff"><?php echo HEADING_PRODUCTS; ?></b></td>
                  </tr>
<?php
  }
...
?>
      ...
      <tr bgcolor="#9F7EA9">
        <td class="main" colspan="3"  ><b style="color:#fff"><?php echo HEADING_BILLING_INFORMATION; ?></b></td>
      </tr>
      <tr>
        <td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
      </tr>
      <tr>
        <td><table border="0" width="100%" cellspacing="1" cellpadding="2"  >
          <tr >
            <td width="30%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr  bgcolor="#9F7EA9">
                <td class="main"><b style="color:#fff"><?php echo HEADING_BILLING_ADDRESS; ?></b></td>
              </tr>
              <tr>
                <td class="main"><?php echo tep_address_format($order->billing['format_id'], $order->billing, 1, ' ', '<br>'); ?></td>
              </tr>
              <tr>
                <td class="main"><b style="color:#FFFFFF"><?php echo HEADING_PAYMENT_METHOD; ?></b></td>
              </tr>
              <tr>
...
?>
      ...
      <tr  bgcolor="#9F7EA9">
        <td class="main"><b style="color:#fff"><?php echo HEADING_ORDER_HISTORY; ?></b></td>
      </tr>
      <tr>
        <td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
      </tr>
