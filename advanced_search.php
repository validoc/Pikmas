      ...
      <table border="0" width="100%" cellspacing="3" cellpadding="3">
        <tr>
          ...
          <td width="100%" valign="top"><?php echo tep_draw_form('advanced_search', tep_href_link(FILENAME_ADVANCED_SEARCH_RESULT, '', 'NONSSL', false), 'get', 'onSubmit="return check_form(this);"') . tep_hide_session_id(); ?><table border="0" width="100%" cellspacing="0" cellpadding="0">
              ...
              ?>
              <tr>
                <td class="adsearch" style="padding: 0 100px;">
                  <?php
                    ...
                    <tr >
                      <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
                          ...
                          <tr>
                            ...
                            <td class="fieldValue">
                              <select name="price">
                                ...
                                <option value="60">Hasta 60 &euro;</option>
                                <option value="70">Hasta 70 &euro;</option>
                              </select>
                            </td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td class="fieldKey">Ordenar por:</td>
                            <td  class="fieldValue">
                              <select name="sort">
                                <option value="1d">Producto</option>
                                <option value="0d">Categor&iacute;a</option>
                                <option value="3d">Precio</option>
                                <option value="2d">Familia</option>
                              </select>
                            </td>
                          </tr>
                          <tr>
