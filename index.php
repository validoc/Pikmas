...
<tr>
<td>
<?php require(DIR_WS_INCLUDES . 'header.php'); ?></td>
</tr>
<tr>
<td>
<!-- header_eof //-->
...
stepcarousel.setup({
  ...
  <tr>
    ...
    <td colspan="2" align="center"><?php if ($banner = tep_banner_exists('dynamic', 'izquierda1')) { echo tep_display_banner('static', $banner); }?></td>
</tr>
<tr>
   <td colspan="2" align="center"><?php if ($banner = tep_banner_exists('dynamic', 'derecha1')) { echo tep_display_banner('static', $banner); }?></td>
 ...
 <?php
  ...
  <tr>
    ...
    <td colspan="2" align="center"><?php if ($banner = tep_banner_exists('dynamic', 'izquierda2')) { echo tep_display_banner('static', $banner); }?></td>
</tr>
<tr>
   <td  colspan="2" align="center"><?php if ($banner = tep_banner_exists('dynamic', 'derecha2')) { echo tep_display_banner('static', $banner); }?></td>
    </tr>
 ...
 <?php
  ...
  <tr>
    ...
    <td align="center"><?php if ($banner = tep_banner_exists('dynamic', 'baner1')) { echo tep_display_banner('static', $banner); }?></td>

    <td align="center"><?php if ($banner = tep_banner_exists('dynamic', 'baner2')) { echo tep_display_banner('static', $banner); }?></td>
    </tr>


  <tr>

    <td align="center"><?php if ($banner = tep_banner_exists('dynamic', 'baner3')) { echo tep_display_banner('static', $banner); }?></td>

    <td align="center"><?php if ($banner = tep_banner_exists('dynamic', 'baner4')) { echo tep_display_banner('static', $banner); }?></td>
    </tr>
