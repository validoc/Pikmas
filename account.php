...
<!-- body_text //-->
    <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="0" style="text-align:left">
      <tr>
            ...
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                <td class="main" align="center" valign="top" width="130">
                    <div class="m1"><?php echo '<b>' . OVERVIEW_PREVIOUS_ORDERS . '</b><br>'; ?></div>
                  ...
                  <tr class="moduleRow" onMouseOver="rowOverEffect(this)" onMouseOut="rowOutEffect(this)" onClick="document.location.href='<?php echo tep_href_link(FILENAME_ACCOUNT_HISTORY_INFO, 'order_id=' . $orders['orders_id'], 'SSL'); ?>'">
                      ...
                      <td>
                          <table class="tablePedido">
                              ...
                              <tr>
                                  <td class="main" align="right"> <strong><?php echo $orders['orders_status_name']; ?></strong></td>
                ...
                <tr>
                   <td>
                      <div class="btnPedidos">
                          <?php echo '<a href="' . tep_href_link(FILENAME_ACCOUNT_HISTORY, '', 'SSL') . '"><u>' . OVERVIEW_SHOW_ALL_ORDERS . '</u></a>'; ?>
                      </div>
                   </td>
              </tr>
            </table></td>
